...
ActiveRecord::Schema[7.1].define(version: 2025_07_26_014547) do
  ...
  create_table "powerpoints", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["portfolio_id"], name: "index_powerpoints_on_portfolio_id"
  end
  ...
  add_foreign_key "powerpoints", "portfolios"
